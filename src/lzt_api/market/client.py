...
from lzt_api.market.models import AutoPayments_CreateResponse, AutoPayments_ListResponse, BatchResponse, Cart_AddResponse, Cart_DeleteResponse, Category_BattleNetResponse, Category_ChatGPTResponse, Category_DiscordResponse, Category_EAResponse, Category_EpicGamesResponse, Category_EscapeFromTarkovResponse, Category_FortniteResponse, Category_GamesResponse, Category_GiftsResponse, Category_HytaleResponse, Category_InstagramResponse, Category_ListResponse, Category_MihoyoResponse, Category_MinecraftResponse, Category_ParamsResponse, Category_RiotResponse, Category_RobloxResponse, Category_SocialClubResponse, Category_SteamResponse, Category_SupercellResponse, Category_TelegramResponse, Category_TikTokResponse, Category_UplayResponse, Category_VpnResponse, Category_WarfaceResponse, Category_WotBlitzResponse, Category_WotResponse, ConfirmationCodeModel, CustomDiscounts_CreateResponse, CustomDiscounts_EditResponse, CustomDiscounts_GetResponse, ExtraModel, ItemListModel, List_StatesResponse, Managing_AIPriceResponse, Managing_AutoBuyPriceResponse, Managing_BulkGetResponse, Managing_ChangePasswordResponse, Managing_CheckGuaranteeResponse, Managing_CreateClaimResponse, Managing_GetLetters2Response, Managing_GetResponse, Managing_ImageResponse, Managing_SteamInventoryValueResponse, Managing_SteamUpdateValueResponse, Managing_SteamValueResponse, Managing_Steam_GetMafileResponse, Managing_TelegramCodeResponse, Managing_TempEmailPasswordResponse, Payments_CurrencyResponse, Payments_FeeResponse, Payments_HistoryResponse, Payments_Invoice_CreateResponse, Payments_Invoice_GetResponse, Payments_Invoice_ListResponse, Payments_PayoutServicesResponse, Profile_ClaimsResponse, Profile_GetResponse, Proxy_GetResponse, Publishing_AddResponse, Publishing_FastSellResponse, Purchasing_ConfirmResponse
...
class MarketClient(BaseClient):
    ...
    def category_steam(
        ...
        trade_limit: str | None = None,
        daybreak: int | None = None,
        limit: str | None = None,
        mafile: str | None = None,
        reg: int | None = None,
        ...
        last_trans_date_period_later: str | None = None,
    ...
    def category_fortnite(
        ...
        last_trans_date_period: str | None = None,
        no_trans: bool | None = None,
        xbox_linkable: str | None = None,
        psn_linkable: str | None = None,
        daybreak: int | None = None,
    ...
    def category_ea(
        ...
        has_ban: str | None = None,
        xbox_connected: str | None = None,
        steam_connected: str | None = None,
        psn_connected: str | None = None,
    ...
    def category_instagram(
        ...
        login_without_cookies: str | None = None,
        followers_min: int | None = None,
        followers_max: int | None = None,
        post_min: int | None = None,
        post_max: int | None = None,
    ...
    def category_battle_net(
        ...
        not_country: list[str] | None = None,
        tel: str | None = None,
        edit_btag: str | None = None,
        changeable_fn: str | None = None,
        real_id: str | None = None,
        parent_control: str | None = None,
        no_bans: str | None = None,
        balance_min: int | None = None,
        balance_max: int | None = None,
    ...
    def category_minecraft(
        ...
        dungeons: str | None = None,
        legends: str | None = None,
        change_nickname: str | None = None,
        capes: list[str] | None = None,
        capes_min: int | None = None,
        capes_max: int | None = None,
        country: list[str] | None = None,
        not_country: list[str] | None = None,
        hypixel_ban: str | None = None,
        hypixel_skyblock_api_enabled: str | None = None,
